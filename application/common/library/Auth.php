...
class Auth
{
    ...
    protected $config = [];
    protected $options = [];
    protected $allowFields = ['id','merchant_id', 'username', 'nickname', 'mobile', 'avatar', 'score','money','group_id','bio','paypassword',
                                'googlesecret','googlebind','mobilebind','successions','loginip','public_key','req_url',
                                'payrate_type','payrate'];
