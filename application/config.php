...
return [
    ...
    'log'                    => [
        ...
        'path'  => LOG_PATH,
        // 日志记录级别
        'level' => ['API','NOTIFY','REPAY_ERROR','REPAY_NOTIFY','CHANNEL','SIGN','error','info','debug','notice','sql'],
        'apart_level'=>['API','NOTIFY','REPAY_ERROR','REPAY_NOTIFY','CHANNEL','error','sql','SIGN']
    ],
    // +----------------------------------------------------------------------
    ...
    'easypay'=>[
        'safeCode'=>'6d002d854d579b6bfb19edc1aac53287'      //默认密码402368
    ],
    //FastAdmin配置
    'fastadmin'              => [
        //是否开启前台会员中心
