<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:74:"/mnt/projects/espay/public/../application/admin/view/api/upstream/add.html";i:1574294804;s:62:"/mnt/projects/espay/application/admin/view/layout/default.html";i:1574294804;s:59:"/mnt/projects/espay/application/admin/view/common/meta.html";i:1574294804;s:61:"/mnt/projects/espay/application/admin/view/common/script.html";i:1574294804;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-10">
            <dl class="fieldlist" data-name="params" data-template="param-tpl">
                ...
                <textarea name="row[params]"  class="form-control hide" cols="30" rows="5" disabled></textarea>

                <script type="text/html" id="param-tpl">
                    <dd class="form-inline">
                        <input type="text" name="row[<%=name%>][<%=index%>][name]" class="form-control" value="<%=row['name']%>" size="10">
                        <input type="text" name="row[<%=name%>][<%=index%>][code]" class="form-control" value="<%=row['gender']%>" size="30">
                        <select name="row[<%=name%>][<%=index%>][type]" class="form-control">
                        ...
                        <input type="text" name="row[<%=name%>][<%=index%>][default]" class="form-control" value="<%=row['score']%>" size="30">
