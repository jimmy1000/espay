<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:73:"/mnt/projects/espay/public/../application/admin/view/api/account/add.html";i:1574294804;s:62:"/mnt/projects/espay/application/admin/view/layout/default.html";i:1574294804;s:59:"/mnt/projects/espay/application/admin/view/common/meta.html";i:1574294804;s:61:"/mnt/projects/espay/application/admin/view/common/script.html";i:1574294804;}*/ ?>
<!DOCTYPE html>
              ...
              <% if(params[i].type == 'input') { %>
                ...
                <div class="input-group">
                    ...
                    <div class="input-group-addon no-border no-padding">
                        <span><button type="button" id="plupload-avatar" class="btn btn-info plupload" data-input-id="c-param-<%= params[i].code%>" data-mimetype="text/plain,application/x-mspublisher
